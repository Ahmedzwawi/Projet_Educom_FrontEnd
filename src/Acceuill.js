        ...
        <div className="container">
          <nav className="navbar navbar-expand-lg custom_nav-container ">
            <a className="navbar-brand" href="index.html">
              <img src="assets/images/log.png.PNG" alt />
              <span>
                EDU'COM
              </span>
            </a>
      ...
      <div id="about" className="about">
        <div className="container">
          ...
          <p className="text-center">
            EDUCOM est le plateforme idiale de communication en ligne créer par Ahmed Zwawi et Moutiaa Dimassi en 2021.
          </p>
        ...
        <div className="container">
          ...
          <div className="teacher_container layout_padding2">
            <div className="card-deck">
              <div className="card">
                <img className="card-img-top" src="assets/images/moutia.png" alt="Card image cap" />
                <div className="card-body">
                  <h5 className="card-title">Moutia Dimassi</h5>
                </div>
              </div>
              <div className="card">
                <img className="card-img-top" src="assets/images/Ahmed_Zwawi.png" alt="Card image cap" />
                <div className="card-body">
