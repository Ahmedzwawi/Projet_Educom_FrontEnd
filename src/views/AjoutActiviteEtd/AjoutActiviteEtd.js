...
envoyer(){
  ...
  axios.put(`http://localhost:8000/ReponseActivites/addReponseActivites/${localStorage.getItem('idUseer')}/${localStorage.getItem('idGoupe')}/${localStorage.getItem('idE')}/${localStorage.getItem('idREPETD')}`,fd1)
